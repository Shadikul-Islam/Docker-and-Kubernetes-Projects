...
**Data Source:** _It will be the VM IP address of the Nodes. (20.85.228.101,30001;)_

**Port:** _It will be Nodeport IP that you will defined on Manifest. We will discuss it below in details._

**Database Name:** _Set your database name what you want._

**User ID:** _sa_

**Password:** _AnyStrongPassword_
